...
Accepted runs: [I2V smoke validation](I2V_SMOKE_2026-08-17.md), [REF2VA smoke validation](REF2VA_SMOKE_2026-08-17.md), [full I2V/REF2VA validation](FULL_WORKFLOWS_2026-08-17.md), [checkpoint recycling validation](CHECKPOINT_RECYCLING_2026-08-17.md), [repeatable cold/warm benchmark](COLD_WARM_BENCHMARK_2026-08-17.md), [speed/quality variants](SPEED_QUALITY_VARIANTS_2026-08-17.md), [full Turbo release validation](FULL_TURBO_RELEASE_2026-08-17.md), [Turbo workflow usage](TURBO_WORKFLOW_USAGE.md), and the O6 matched FP32/safe-FP16 report in [English](SAFE_FP16_FSDP_2026-08.md) or [Chinese](SAFE_FP16_FSDP_2026-08.zh-CN.md). The O6 report itself is the exhaustive ledger for completed, failed, incomplete, profiler-distorted and microbenchmark-only attempts; the [Chinese](../../releases/2026-08-18-o6-minimax-h3-safe-fp16.zh-CN.md) and [English](../../releases/2026-08-18-o6-minimax-h3-safe-fp16.en.md) upgrade records provide the release-oriented view of the same decisions. The O6 design and baseline protocol are available in [English](../../superpowers/plans/2026-08-18-minimax-h3-safe-fp16-fsdp.md) and [Chinese](../../superpowers/plans/2026-08-18-minimax-h3-safe-fp16-fsdp.zh-CN.md). MiniMax H3 requires `--reserve-vram 2` in addition to `--disable-cuda-malloc` on this stack. Full workflows default to FSDP CPU offload. The original smoke validations kept CPU offload disabled; the O2 and O3 repeatability benchmarks intentionally enabled it to match the reusable full-workflow operating mode. REF2VA also requires the preprocessing-to-worker cleanup barrier recorded in the REF2VA report.
